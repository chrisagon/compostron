...
<div class="page-header row">
	<h1><img src="summary_reports-logo-lg.png" style="height: 1em;"> Rapport de synthèse</h1>
	<h1>
...
<?php
	...
	$summary_reports_file .= '<div class="page-header"><h1>Rapport de synthèse</h1></div>';
