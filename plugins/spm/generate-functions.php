<?php
	...
	function includeNeededParts( &$fileContent , $includesArray, $spm ){
		...
		if ( $includesArray['orderBy']){
			$spm->progress_log->add("'Trier par' section included: ", 'spacer');
			$fileContent.='    
			...
			<div class="row">
				...
				<?php if($saveFiltersFlag == "True"){ ?>
					<div class="col-md-3 col-lg-2 vspacer-lg">
						<button type="submit" onclick="beforeApplyFilters(event);return true;" class="btn btn-default btn-block btn-lg" id="SaveFilter" name="SaveFilter_x" value="1"><i class="glyphicon glyphicon-align-left"></i> Save &amp;  Appliquer la selection</button>
					</div>
				<?php } ?>
				<div class="col-md-3 col-lg-2 vspacer-lg">
