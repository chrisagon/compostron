	...
	*/
	...
	$schema = array(
		'depots' => array(
			...
			'sur_le_site' => array('appgini' => 'INT unsigned null '),
			'par_le_membre' => array('appgini' => 'INT unsigned null '),
			'dans_le_bac' => array('appgini' => 'INT unsigned null '),
			'jour_heure' => array('appgini' => 'DATETIME null '),
			'qte_vmh' => array('appgini' => 'DECIMAL(10,2) null '),
			'qte_bds' => array('appgini' => 'DECIMAL(10,2) null '),
			'niveau_du_bac' => array('appgini' => 'VARCHAR(64) null '),
			'cree_par' => array('appgini' => 'VARCHAR(64) null '),
			'date_maj' => array('appgini' => 'TIMESTAMP null '),
		),
		'site_compostage' => array(
			'id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'nom_du_site' => array('appgini' => 'VARCHAR(64) null '),
			'adresse_postale' => array('appgini' => 'VARCHAR(64) null '),
			'acces_au_site' => array('appgini' => 'TEXT null '),
			'type_de_site' => array('appgini' => 'VARCHAR(64) null '),
			'nom_du_responsable' => array('appgini' => 'VARCHAR(64) null '),
			'email_du_responsable' => array('appgini' => 'VARCHAR(64) null default \'adresse@email.com\' '),
			'Telephone_du_responsable' => array('appgini' => 'VARCHAR(64) null '),
			'Commentaires' => array('appgini' => 'TEXT null '),
		),
		'bacs_du_site' => array(
			'id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'appartient_site' => array('appgini' => 'INT unsigned null '),
			'type_de_bacs' => array('appgini' => 'VARCHAR(64) null '),
			'niveau_de_remplissage' => array('appgini' => 'VARCHAR(64) null '),
			'Commentaires' => array('appgini' => 'TEXT null '),
		),
		'membres' => array(
			'id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'Nom' => array('appgini' => 'VARCHAR(64) null '),
			'prenom' => array('appgini' => 'VARCHAR(64) null '),
			'statut' => array('appgini' => 'VARCHAR(64) null default \'habitant\' '),
			'adresse_du_membre' => array('appgini' => 'TEXT null '),
			'email_membre' => array('appgini' => 'VARCHAR(64) null '),
			'Telephone_membre' => array('appgini' => 'VARCHAR(64) null '),
		),
		'transferts' => array(
			'id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'sur_le_site' => array('appgini' => 'INT unsigned null '),
			'par_le_membre' => array('appgini' => 'INT unsigned null '),
			'jour_heure' => array('appgini' => 'DATETIME null '),
			'du_bac' => array('appgini' => 'VARCHAR(64) null '),
			'vers_bac' => array('appgini' => 'VARCHAR(64) null '),
			'quantite' => array('appgini' => 'DECIMAL(10,2) null '),
			'cree_par' => array('appgini' => 'VARCHAR(64) null '),
			'date_maj' => array('appgini' => 'TIMESTAMP null '),
		),
		'intervention' => array(
			'id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'demande_par' => array('appgini' => 'INT unsigned null '),
			'date_demande' => array('appgini' => 'DATETIME null '),
			'realise_par' => array('appgini' => 'INT unsigned null '),
			'date_realisation' => array('appgini' => 'DATETIME null '),
			'pour_site' => array('appgini' => 'INT unsigned null '),
			'pour_bac' => array('appgini' => 'INT unsigned null '),
			'type_intervention' => array('appgini' => 'VARCHAR(64) not null default \'Transfert\' '),
			'statut_intervention' => array('appgini' => 'VARCHAR(64) not null default \'En attente\' '),
