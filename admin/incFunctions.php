	...
	*/
	...
	function get_tables_info($skip_authentication = false) {
		...
		$all_tables = array(
			/* ['table_name' => [table props assoc array] */   
				'depots' => array(
					'Caption' => 'D&#233;p&#244;ts',
					'Description' => 'Indiquez les d&#233;p&#244;ts que vous avez effectu&#233;s sur votre site.',
					'tableIcon' => 'resources/table_icons/light_circle_green.png',
					'group' => $tg[0],
					'homepageShowCount' => 1
				),
				'site_compostage' => array(
					'Caption' => 'Site compostage',
					'Description' => 'Site de d&#233;p&#244;t de vos mati&#232;res compostables et de retrait de votre compost.',
					'tableIcon' => 'resources/table_icons/google_map.png',
					'group' => $tg[0],
					'homepageShowCount' => 0
				),
				'bacs_du_site' => array(
					'Caption' => 'Bacs du site',
					'Description' => 'Permet d\'inventorier les bacs de compostage de chaque site.',
					'tableIcon' => 'resources/table_icons/recycle_bag.png',
					'group' => $tg[2],
					'homepageShowCount' => 0
				),
				'membres' => array(
					'Caption' => 'Membres',
					'Description' => 'Membres des sites du Composthon.',
				...
				'transferts' => array(
					'Caption' => 'Transferts',
					'Description' => 'Les transferts entre bacs sont r&#233;alis&#233;s par le technicien.',
				...
				'intervention' => array(
					...
					'Description' => 'Demande d\'intervention sur site d\'un technicien.',
	...
	if(!function_exists('getTableList')) {
		function getTableList($skip_authentication = false) {
			$arrTables = array(
				'depots' => 'D&#233;p&#244;ts',
				'site_compostage' => 'Site compostage',
				'bacs_du_site' => 'Bacs du site',
				'membres' => 'Membres',
...
########################################################################
	...
	*/
	...
	function get_parent_tables($table) {
		...
		$parents = array(
			'depots' => array(
				'site_compostage' => array('sur_le_site'),
				'membres' => array('par_le_membre'),
				'bacs_du_site' => array('dans_le_bac'),
			),
			'bacs_du_site' => array(
				'site_compostage' => array('appartient_site'),
			),
			'transferts' => array(
				'site_compostage' => array('sur_le_site'),
				'membres' => array('par_le_membre'),
			...
			'intervention' => array(
				'membres' => array('realise_par', 'demande_par'),
				'site_compostage' => array('pour_site'),
				'bacs_du_site' => array('pour_bac'),
			),
		);
