<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'depots' table. 
	...
	*/
	...
	function depots_init(&$options, $memberInfo, &$args) {
		/* Inserted by Search Page Maker for AppGini on 2020-03-26 10:49:56 */
		$options->FilterPage = 'hooks/depots_filter.php';
	...
	*/
	...
	function depots_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function depots_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['sur_le_site'], $data['dans_le_bac'], $data['jour_heure'], $data['qte_vmh'], $data['qte_bds'], $data['niveau_du_bac']
	...
	*/
	...
	function depots_before_insert(&$data, $memberInfo, &$args) {
	 ...
	 * For this table, the array items are: 
	 *     $data['sur_le_site'], $data['par_le_membre'], $data['dans_le_bac'], $data['jour_heure'], $data['qte_vmh'], $data['qte_bds'], $data['niveau_du_bac'], $data['cree_par'], $data['date_maj']
	...
	*/
	...
	function depots_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['sur_le_site'], $data['dans_le_bac'], $data['jour_heure'], $data['qte_vmh'], $data['qte_bds'], $data['niveau_du_bac']
	...
	*/
	...
	function depots_before_update(&$data, $memberInfo, &$args) {
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id'], $data['sur_le_site'], $data['par_le_membre'], $data['dans_le_bac'], $data['jour_heure'], $data['qte_vmh'], $data['qte_bds'], $data['niveau_du_bac'], $data['cree_par'], $data['date_maj']
	...
	*/
	...
	function depots_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function depots_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function depots_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function depots_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function depots_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function depots_batch_actions(&$args) {
