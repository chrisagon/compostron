...
<?php }else{ ?>
	...
	<button class="btn btn-lg btn-default pull-right search_mode" type="submit" name="Filter_x" value="1">Passer en mode de recherche avancée</button>
			...
			<div class="page-header"><h1>
				<a href="bacs_du_site_view.php" style="text-decoration: none; color: inherit;">
					<img src="resources/table_icons/recycle_bag.png"> 					Bacs du site à selectionner</a>
			</h1></div>
	...
	<div class="row vspacer-lg" style="border-bottom: dotted 2px #DDD;">
		...
		<div class="hidden-xs hidden-sm col-md-3 vspacer-lg text-right"><label for="">Appartient au site</label></div>
		<div class="hidden-md hidden-lg col-xs-12 vspacer-lg"><label for="">Appartient au site</label></div>
			...
			if ($j("#filterfield_2").val().length){
				...
				$j.ajax({
					...
					data: {
						...
						p: 1,                                         //page number
						t: "bacs_du_site",                //table name
						f: "appartient_site"               //field name
					}
	...
	<div class="row" style="border-bottom: dotted 2px #DDD;">
		...
		<div class="hidden-xs hidden-sm col-md-3 vspacer-lg text-right"><label for="">Type de bacs</label></div>
		<div class="hidden-md hidden-lg col-xs-12 vspacer-lg"><label for="">Type de bacs</label></div>
		
		
		<input type="hidden" class="optionsData" name="FilterField[2]" value="3">
		<div class="col-xs-10 col-sm-11 col-md-8 col-lg-6">
			...
			<input type="hidden" name="FilterValue[2]" id="3_currValue" value="<?php echo htmlspecialchars($FilterValue[2]); ?>" size="3">

	
			<div class="radio">
				<label>
					 <input type="radio" name="FilterValue[2]" class="filter_3" value='Dépôt'>Dépôt				</label>
			</div>
	 
			<div class="radio">
				<label>
					 <input type="radio" name="FilterValue[2]" class="filter_3" value='Fermentation'>Fermentation				</label>
			</div>
	 
			<div class="radio">
				<label>
					 <input type="radio" name="FilterValue[2]" class="filter_3" value='Maturation'>Maturation				</label>
			</div>
	 
			<div class="radio">
				<label>
					 <input type="radio" name="FilterValue[2]" class="filter_3" value='Affinage'>Affinage				</label>
			</div>
	 		</div>
	...
	<script>
		//for population
		var filterValue_3 = '<?php echo htmlspecialchars($FilterValue[ 2 ]); ?>';
		$j(function () {
			if (filterValue_3) {
