...
<?php }else{ ?>
	...
	<button class="btn btn-lg btn-default pull-right search_mode" type="submit" name="Filter_x" value="1">Passer en mode de recherche avancée</button>
			...
			<div class="page-header"><h1>
				<a href="transferts_view.php" style="text-decoration: none; color: inherit;">
					<img src="resources/table_icons/arrow_switch.png"> 					Transferts à selectionner</a>
			</h1></div>
	...
	<div class="row vspacer-lg" style="border-bottom: dotted 2px #DDD;">
		...
		<div class="hidden-xs hidden-sm col-md-3 vspacer-lg text-right"><label for="">Par le technicien</label></div>
		<div class="hidden-md hidden-lg col-xs-12 vspacer-lg"><label for="">Par le technicien</label></div>
	...
	<div class="row vspacer-lg" style="border-bottom: dotted 2px #DDD;" >
		...
		<div class="hidden-xs hidden-sm col-md-3 vspacer-lg text-right"><label for="">Jour heure</label></div>
		<div class="hidden-md hidden-lg col-xs-12 vspacer-lg"><label for="">Jour heure</label></div>
	...
	<script>
		$j(function(){
			...
			$j("#from-date_4" ).on('dp.change' , function(e){
				...
				$j("#to-date_4 ").val(date.format('YYYY-MM-DD HH:mm:ss')).data("DateTimePicker").minDate(e.date);
			});
		});
	</script>
	...
	<div class="row" style="border-bottom: dotted 2px #DDD;">
		...
		<div class="hidden-xs hidden-sm col-md-3 vspacer-lg text-right"><label for="">Du bac</label></div>
		<div class="hidden-md hidden-lg col-xs-12 vspacer-lg"><label for="">Du bac</label></div>
		
		
		<input type="hidden" class="optionsData" name="FilterField[5]" value="5">
		<div class="col-xs-10 col-sm-11 col-md-8 col-lg-6">
			...
			<input type="hidden" name="FilterValue[5]" id="5_currValue" value="<?php echo htmlspecialchars($FilterValue[5]); ?>" size="3">

	
			<div class="radio">
				<label>
					 <input type="radio" name="FilterValue[5]" class="filter_5" value='Dépôt'>Dépôt				</label>
			</div>
	 
			<div class="radio">
				<label>
					 <input type="radio" name="FilterValue[5]" class="filter_5" value='Fermentation'>Fermentation				</label>
			</div>
	 
			<div class="radio">
				<label>
					 <input type="radio" name="FilterValue[5]" class="filter_5" value='Maturation'>Maturation				</label>
			</div>
	 
			<div class="radio">
				<label>
					 <input type="radio" name="FilterValue[5]" class="filter_5" value='Affinage'>Affinage				</label>
			</div>
	 		</div>
	...
	<script>
		//for population
		var filterValue_5 = '<?php echo htmlspecialchars($FilterValue[ 5 ]); ?>';
		$j(function () {
			if (filterValue_5) {
				$j("input[class =filter_5][value ='" + filterValue_5 + "']").attr("checked", "checked");
			}
		})
	</script>
	...
	<div class="row" style="border-bottom: dotted 2px #DDD;">
		...
		<div class="hidden-xs hidden-sm col-md-3 vspacer-lg text-right"><label for="">Vers bac</label></div>
		<div class="hidden-md hidden-lg col-xs-12 vspacer-lg"><label for="">Vers bac</label></div>
		
		
		<input type="hidden" class="optionsData" name="FilterField[6]" value="6">
		<div class="col-xs-10 col-sm-11 col-md-8 col-lg-6">

			<input type="hidden" name="FilterAnd[6]" value="and">
			<input type="hidden" name="FilterOperator[6]" value="equal-to">
			<input type="hidden" name="FilterValue[6]" id="6_currValue" value="<?php echo htmlspecialchars($FilterValue[6]); ?>" size="3">

	
			<div class="radio">
				<label>
					 <input type="radio" name="FilterValue[6]" class="filter_6" value='Dépôt'>Dépôt				</label>
			</div>
	 
			<div class="radio">
				<label>
					 <input type="radio" name="FilterValue[6]" class="filter_6" value='Fermentation'>Fermentation				</label>
			</div>
	 
			<div class="radio">
				<label>
					 <input type="radio" name="FilterValue[6]" class="filter_6" value='Maturation'>Maturation				</label>
			</div>
	 
			<div class="radio">
				<label>
					 <input type="radio" name="FilterValue[6]" class="filter_6" value='Affinage'>Affinage				</label>
			</div>
	 		</div>
	...
	<script>
		//for population
		var filterValue_6 = '<?php echo htmlspecialchars($FilterValue[ 6 ]); ?>';
		$j(function () {
			if (filterValue_6) {
