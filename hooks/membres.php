<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'membres' table. 
	...
	*/
	...
	function membres_init(&$options, $memberInfo, &$args) {
		/* Inserted by Search Page Maker for AppGini on 2020-03-26 10:49:56 */
		$options->FilterPage = 'hooks/membres_filter.php';
	...
	*/
	...
	function membres_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function membres_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['Nom'], $data['prenom'], $data['statut'], $data['adresse_du_membre'], $data['email_membre'], $data['Telephone_membre']
	...
	*/
	...
	function membres_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function membres_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['Nom'], $data['prenom'], $data['statut'], $data['adresse_du_membre'], $data['email_membre'], $data['Telephone_membre']
	...
	*/
	...
	function membres_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function membres_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function membres_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function membres_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function membres_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function membres_csv($query, $memberInfo, &$args) {
