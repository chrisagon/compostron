<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'intervention' table. 
	...
	*/
	...
	function intervention_init(&$options, $memberInfo, &$args) {
		/* Inserted by Search Page Maker for AppGini on 2020-03-26 10:49:56 */
		$options->FilterPage = 'hooks/intervention_filter.php';
	...
	*/
	...
	function intervention_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function intervention_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['demande_par'], $data['realise_par'], $data['pour_site'], $data['pour_bac'], $data['type_intervention'], $data['description']
	...
	*/
	...
	function intervention_before_insert(&$data, $memberInfo, &$args) {
	 ...
	 * For this table, the array items are: 
	 *     $data['demande_par'], $data['realise_par'], $data['pour_site'], $data['pour_bac'], $data['type_intervention'], $data['description'], $data['cree_par'], $data['date_maj']
	...
	*/
	...
	function intervention_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['demande_par'], $data['realise_par'], $data['pour_site'], $data['pour_bac'], $data['type_intervention'], $data['description']
	...
	*/
	...
	function intervention_before_update(&$data, $memberInfo, &$args) {
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id'], $data['demande_par'], $data['realise_par'], $data['pour_site'], $data['pour_bac'], $data['type_intervention'], $data['description'], $data['cree_par'], $data['date_maj']
	...
	*/
	...
	function intervention_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function intervention_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function intervention_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function intervention_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function intervention_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function intervention_batch_actions(&$args) {
