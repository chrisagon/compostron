...
<?php }else{ ?>
	...
	<button class="btn btn-lg btn-default pull-right search_mode" type="submit" name="Filter_x" value="1">Passer en mode de recherche avancée</button>
			...
			<div class="page-header"><h1>
				<a href="site_compostage_view.php" style="text-decoration: none; color: inherit;">
					<img src="resources/table_icons/google_map.png"> 					Site compostage à selectionner</a>
			</h1></div>

				
	<div class="row vspacer-lg" style="border-bottom: dotted 2px #DDD;" >
		
		<div class="hidden-xs hidden-sm col-md-3 vspacer-lg text-right"><label for="">Nom du site</label></div>
		<div class="hidden-md hidden-lg col-xs-12 vspacer-lg"><label for="">Nom du site</label></div>
	...
	<div class="row" style="border-bottom: dotted 2px #DDD;">
		...
		<div class="hidden-xs hidden-sm col-md-3 vspacer-lg text-right"><label for="">Type de site</label></div>
		<div class="hidden-md hidden-lg col-xs-12 vspacer-lg"><label for="">Type de site</label></div>
		...
		<div class="col-xs-10 col-sm-11 col-md-8 col-lg-6">
			...
			<div class="radio">
				<label>
					 <input type="radio" name="FilterValue[2]" class="filter_5" value='Ecole'>Ecole				</label>
			</div>
	 
			<div class="radio">
				<label>
					 <input type="radio" name="FilterValue[2]" class="filter_5" value='Partagé'>Partagé				</label>
			</div>
	 		</div>
	...
	<div class="row vspacer-lg" style="border-bottom: dotted 2px #DDD;" >
		...
		<div class="hidden-xs hidden-sm col-md-3 vspacer-lg text-right"><label for="">Nom du responsable</label></div>
		<div class="hidden-md hidden-lg col-xs-12 vspacer-lg"><label for="">Nom du responsable</label></div>
