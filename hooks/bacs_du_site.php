<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'bacs_du_site' table. 
	...
	*/
	...
	function bacs_du_site_init(&$options, $memberInfo, &$args) {
		/* Inserted by Search Page Maker for AppGini on 2020-03-26 10:49:56 */
		$options->FilterPage = 'hooks/bacs_du_site_filter.php';
	...
	*/
	...
	function bacs_du_site_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function bacs_du_site_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['appartient_site'], $data['type_de_bacs'], $data['niveau_de_remplissage'], $data['Commentaires']
	...
	*/
	...
	function bacs_du_site_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function bacs_du_site_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['appartient_site'], $data['type_de_bacs'], $data['niveau_de_remplissage'], $data['Commentaires']
	...
	*/
	...
	function bacs_du_site_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function bacs_du_site_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function bacs_du_site_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function bacs_du_site_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function bacs_du_site_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function bacs_du_site_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function bacs_du_site_batch_actions(&$args) {
