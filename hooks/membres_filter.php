...
<?php }else{ ?>
	...
	<button class="btn btn-lg btn-default pull-right search_mode" type="submit" name="Filter_x" value="1">Passer en mode de recherche avancée</button>
			...
			<div class="page-header"><h1>
				<a href="membres_view.php" style="text-decoration: none; color: inherit;">
					<img src="resources/table_icons/group.png"> 					Membres à selectionner</a>
			</h1></div>

				
	<div class="row vspacer-lg" style="border-bottom: dotted 2px #DDD;" >
		
		<div class="hidden-xs hidden-sm col-md-3 vspacer-lg text-right"><label for="">Nom</label></div>
		<div class="hidden-md hidden-lg col-xs-12 vspacer-lg"><label for="">Nom</label></div>
	...
	<div class="row" style="border-bottom: dotted 2px #DDD;">
		...
		<div class="col-xs-10 col-sm-11 col-md-8 col-lg-6">
			...
			<div class="radio">
				<label>
					 <input type="radio" name="FilterValue[2]" class="filter_4" value='habitant'>habitant				</label>
			</div>
	 
			<div class="radio">
				<label>
					 <input type="radio" name="FilterValue[2]" class="filter_4" value='animateur'>animateur				</label>
			</div>
	 
			<div class="radio">
				<label>
					 <input type="radio" name="FilterValue[2]" class="filter_4" value='technicien'>technicien				</label>
			</div>
	 
			<div class="radio">
				<label>
					 <input type="radio" name="FilterValue[2]" class="filter_4" value='administrateur'>administrateur				</label>
			</div>
	 		</div>
