<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'site_compostage' table. 
	...
	*/
	...
	function site_compostage_init(&$options, $memberInfo, &$args) {
		/* Inserted by Search Page Maker for AppGini on 2020-03-26 10:49:56 */
		$options->FilterPage = 'hooks/site_compostage_filter.php';
	...
	*/
	...
	function site_compostage_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function site_compostage_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['nom_du_site'], $data['adresse_du_site'], $data['type_de_site'], $data['nom_du_responsable'], $data['email_du_responsable'], $data['Telephone_du_responsablee'], $data['Commentaires']
	...
	*/
	...
	function site_compostage_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function site_compostage_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['nom_du_site'], $data['adresse_du_site'], $data['type_de_site'], $data['nom_du_responsable'], $data['email_du_responsable'], $data['Telephone_du_responsablee'], $data['Commentaires']
	...
	*/
	...
	function site_compostage_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function site_compostage_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function site_compostage_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function site_compostage_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function site_compostage_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function site_compostage_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function site_compostage_batch_actions(&$args) {
