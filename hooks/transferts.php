<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'transferts' table. 
	...
	*/
	...
	function transferts_init(&$options, $memberInfo, &$args) {
		/* Inserted by Search Page Maker for AppGini on 2020-03-26 10:49:56 */
		$options->FilterPage = 'hooks/transferts_filter.php';
	...
	*/
	...
	function transferts_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function transferts_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['sur_le_site'], $data['par_le_membre'], $data['jour_heure'], $data['du_bac'], $data['vers_bac'], $data['quantite']
	...
	*/
	...
	function transferts_before_insert(&$data, $memberInfo, &$args) {
	 ...
	 * For this table, the array items are: 
	 *     $data['sur_le_site'], $data['par_le_membre'], $data['jour_heure'], $data['du_bac'], $data['vers_bac'], $data['quantite'], $data['cree_par'], $data['date_maj']
	...
	*/
	...
	function transferts_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['sur_le_site'], $data['par_le_membre'], $data['jour_heure'], $data['du_bac'], $data['vers_bac'], $data['quantite']
	...
	*/
	...
	function transferts_before_update(&$data, $memberInfo, &$args) {
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id'], $data['sur_le_site'], $data['par_le_membre'], $data['jour_heure'], $data['du_bac'], $data['vers_bac'], $data['quantite'], $data['cree_par'], $data['date_maj']
	...
	*/
	...
	function transferts_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function transferts_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function transferts_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function transferts_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function transferts_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function transferts_batch_actions(&$args) {
