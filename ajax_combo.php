...
*/
	...
	$lookups = array(
		'depots' => array(
			'sur_le_site' => array(
				'parent_table' => 'site_compostage',
				'parent_pk_field' => 'id',
				'parent_caption' => 'IF(CHAR_LENGTH(`site_compostage`.`nom_du_site`), CONCAT_WS(\'\', `site_compostage`.`nom_du_site`, \' \'), \'\')',
				'parent_from' => '`site_compostage` ',
				'filterers' => array(),
				'custom_query' => '',
			...
			'par_le_membre' => array(
				'parent_table' => 'membres',
				'parent_pk_field' => 'id',
				'parent_caption' => 'IF(CHAR_LENGTH(`membres`.`prenom`) || CHAR_LENGTH(`membres`.`Nom`), CONCAT_WS(\'\', `membres`.`prenom`, `membres`.`Nom`), \'\')',
				'parent_from' => '`membres` ',
				'filterers' => array(),
				'custom_query' => '',
				'inherit_permissions' => false,
			...
			'dans_le_bac' => array(
				'parent_table' => 'bacs_du_site',
				'parent_pk_field' => 'id',
				'parent_caption' => 'IF(CHAR_LENGTH(`bacs_du_site`.`type_de_bacs`) || CHAR_LENGTH(`bacs_du_site`.`appartient_site`), CONCAT_WS(\'\', `bacs_du_site`.`type_de_bacs`, \' du site \', IF(    CHAR_LENGTH(`site_compostage1`.`nom_du_site`), CONCAT_WS(\'\',   `site_compostage1`.`nom_du_site`), \'\')), \'\')',
				'parent_from' => '`bacs_du_site` LEFT JOIN `site_compostage` as site_compostage1 ON `site_compostage1`.`id`=`bacs_du_site`.`appartient_site` ',
				'filterers' => array('sur_le_site' => 'appartient_site'),
				'custom_query' => '',
				'inherit_permissions' => false,
				'list_type' => 0,
				'not_null' => false
		...
		'bacs_du_site' => array(
			'appartient_site' => array(
				'parent_table' => 'site_compostage',
				'parent_pk_field' => 'id',
				'parent_caption' => '`site_compostage`.`nom_du_site`',
				'parent_from' => '`site_compostage` ',
				'filterers' => array(),
				'custom_query' => '',
				'inherit_permissions' => false,
		...
		'transferts' => array(
			...
			'par_le_membre' => array(
				'parent_table' => 'membres',
				'parent_pk_field' => 'id',
				'parent_caption' => 'IF(CHAR_LENGTH(`membres`.`Nom`) || CHAR_LENGTH(`membres`.`prenom`), CONCAT_WS(\'\', `membres`.`Nom`, `membres`.`prenom`), \'\')',
				'parent_from' => '`membres` ',
				'filterers' => array(),
				'custom_query' => '',
				'inherit_permissions' => false,
		...
		'intervention' => array(
			...
			'pour_bac' => array(
				...
				'parent_caption' => 'IF(CHAR_LENGTH(`bacs_du_site`.`type_de_bacs`) || CHAR_LENGTH(`bacs_du_site`.`appartient_site`), CONCAT_WS(\'\', `bacs_du_site`.`type_de_bacs`, \' du site \', IF(    CHAR_LENGTH(`site_compostage1`.`nom_du_site`), CONCAT_WS(\'\',   `site_compostage1`.`nom_du_site`), \'\')), \'\')',
				'parent_from' => '`bacs_du_site` LEFT JOIN `site_compostage` as site_compostage1 ON `site_compostage1`.`id`=`bacs_du_site`.`appartient_site` ',
				'filterers' => array('pour_site' => 'appartient_site'),
				'custom_query' => '',
				'inherit_permissions' => false,
				'list_type' => 0,
				'not_null' => false
